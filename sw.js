...
const CACHE = 'zyncosoft-tarjetas-v14';
...
self.addEventListener('fetch', (event) => {
  ...
  event.respondWith(
    fetch(req)
      ...
      .catch(() =>
        // ignoreSearch: el HTML pide "card.js?v=5" pero en caché está "card.js"
        // (sin query). Sin esto, offline no encontraría el script y la tarjeta
        // quedaría sin datos.
